...
SELECT 'stg_brokers' AS [table], COUNT(*) AS [rows] FROM [$(ETL_SCHEMA)].[stg_brokers]
UNION ALL SELECT 'stg_groups', COUNT(*) FROM [$(ETL_SCHEMA)].[stg_groups]
UNION ALL SELECT 'stg_products', COUNT(*) FROM [$(ETL_SCHEMA)].[stg_products]
UNION ALL SELECT 'stg_plans', COUNT(*) FROM [$(ETL_SCHEMA)].[stg_plans]
UNION ALL SELECT 'stg_schedules', COUNT(*) FROM [$(ETL_SCHEMA)].[stg_schedules]
UNION ALL SELECT 'stg_schedule_versions', COUNT(*) FROM [$(ETL_SCHEMA)].[stg_schedule_versions]
UNION ALL SELECT 'stg_schedule_rates', COUNT(*) FROM [$(ETL_SCHEMA)].[stg_schedule_rates]
...
UNION ALL SELECT 'stg_commission_assignment_versions', COUNT(*) FROM [$(ETL_SCHEMA)].[stg_commission_assignment_versions]
UNION ALL SELECT 'stg_commission_assignment_recipients', COUNT(*) FROM [$(ETL_SCHEMA)].[stg_commission_assignment_recipients]
UNION ALL SELECT 'stg_policies', COUNT(*) FROM [$(ETL_SCHEMA)].[stg_policies]
UNION ALL SELECT 'stg_premium_transactions', COUNT(*) FROM [$(ETL_SCHEMA)].[stg_premium_transactions]
ORDER BY [table];
