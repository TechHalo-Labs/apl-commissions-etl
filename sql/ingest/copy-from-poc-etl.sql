...
PRINT '============================================================';
PRINT 'INGEST: Copy Raw Data (poc_etl → etl)';
PRINT '============================================================';
PRINT '';
...
SELECT @cert_count = COUNT(*) FROM [$(SOURCE_SCHEMA)].[raw_certificate_info];
...
BEGIN
    ...
    SELECT * FROM [$(SOURCE_SCHEMA)].[raw_certificate_info];
...
SELECT @sched_count = COUNT(*) FROM [$(SOURCE_SCHEMA)].[raw_schedule_rates];
...
SELECT @perf_count = COUNT(*) FROM [$(SOURCE_SCHEMA)].[raw_perf_groups];
...
BEGIN
    ...
    SELECT * FROM [$(SOURCE_SCHEMA)].[raw_perf_groups];
...
SELECT @prem_count = COUNT(*) FROM [$(SOURCE_SCHEMA)].[raw_premiums];
...
BEGIN
    ...
    SELECT * FROM [$(SOURCE_SCHEMA)].[raw_premiums];
...
SELECT @ind_broker_count = COUNT(*) FROM [$(SOURCE_SCHEMA)].[raw_individual_brokers];
...
BEGIN
    ...
    SELECT * FROM [$(SOURCE_SCHEMA)].[raw_individual_brokers];
...
SELECT @org_broker_count = COUNT(*) FROM [$(SOURCE_SCHEMA)].[raw_org_brokers];
...
BEGIN
    ...
    SELECT * FROM [$(SOURCE_SCHEMA)].[raw_org_brokers];
...
BEGIN TRY
    ...
    SELECT @lic_count = COUNT(*) FROM [$(SOURCE_SCHEMA)].[raw_licenses];
    ...
    BEGIN
        ...
        SELECT * FROM [$(SOURCE_SCHEMA)].[raw_licenses];
...
END TRY
BEGIN CATCH
    PRINT '   ⚠️  raw_licenses not found or schema mismatch, skipping';
END CATCH
...
BEGIN TRY
    ...
    SELECT @eo_count = COUNT(*) FROM [$(SOURCE_SCHEMA)].[raw_eo_insurance];
    ...
    BEGIN
        ...
        SELECT * FROM [$(SOURCE_SCHEMA)].[raw_eo_insurance];
...
END TRY
BEGIN CATCH
    PRINT '   ⚠️  raw_eo_insurance not found or schema mismatch, skipping';
END CATCH
