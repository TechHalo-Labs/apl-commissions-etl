...
-- Brokers
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_brokers];
CREATE TABLE [$(ETL_SCHEMA)].[stg_brokers] (
    Id BIGINT NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_brokers]';

-- =============================================================================
-- Broker Licenses
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_broker_licenses];
CREATE TABLE [$(ETL_SCHEMA)].[stg_broker_licenses] (
    Id BIGINT NOT NULL,
    BrokerId BIGINT,
    [State] NVARCHAR(10),
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_broker_licenses]';

-- =============================================================================
-- Broker E&O Insurance
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_broker_eo_insurances];
CREATE TABLE [$(ETL_SCHEMA)].[stg_broker_eo_insurances] (
    Id BIGINT NOT NULL,
    BrokerId BIGINT,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_broker_eo_insurances]';

-- =============================================================================
-- Products
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_products];
CREATE TABLE [$(ETL_SCHEMA)].[stg_products] (
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_products]';

-- =============================================================================
-- Product Codes - Individual codes linked to their parent category
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_product_codes];
CREATE TABLE [$(ETL_SCHEMA)].[stg_product_codes] (
    Id BIGINT NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_product_codes]';

CREATE NONCLUSTERED INDEX IX_stg_product_codes_ProductId ON [$(ETL_SCHEMA)].[stg_product_codes] (ProductId);
CREATE NONCLUSTERED INDEX IX_stg_product_codes_Code ON [$(ETL_SCHEMA)].[stg_product_codes] (Code);

-- =============================================================================
-- Plans - Unique plan codes linked to their parent product category
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_plans];
CREATE TABLE [$(ETL_SCHEMA)].[stg_plans] (
    Id NVARCHAR(100) NOT NULL,
    ProductId NVARCHAR(100) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_plans]';

CREATE NONCLUSTERED INDEX IX_stg_plans_ProductId ON [$(ETL_SCHEMA)].[stg_plans] (ProductId);
CREATE NONCLUSTERED INDEX IX_stg_plans_PlanCode ON [$(ETL_SCHEMA)].[stg_plans] (PlanCode);

-- =============================================================================
-- Groups (employer groups with policies)
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_groups];
CREATE TABLE [$(ETL_SCHEMA)].[stg_groups] (
    Id NVARCHAR(100) NOT NULL,
    Name NVARCHAR(500),
    [Description] NVARCHAR(2000),
    Code NVARCHAR(100),
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_groups]';

-- =============================================================================
-- Schedules
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_schedules];
CREATE TABLE [$(ETL_SCHEMA)].[stg_schedules] (
    Id BIGINT NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_schedules]';

-- =============================================================================
-- Schedule Versions
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_schedule_versions];
CREATE TABLE [$(ETL_SCHEMA)].[stg_schedule_versions] (
    Id BIGINT NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_schedule_versions]';

-- =============================================================================
-- Schedule Rates
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_schedule_rates];
CREATE TABLE [$(ETL_SCHEMA)].[stg_schedule_rates] (
    Id BIGINT NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_schedule_rates]';

CREATE NONCLUSTERED INDEX IX_stg_schedule_rates_ProductCode_State
ON [$(ETL_SCHEMA)].[stg_schedule_rates] (ProductCode, [State]);

-- =============================================================================
-- Policies
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_policies];
CREATE TABLE [$(ETL_SCHEMA)].[stg_policies] (
    Id NVARCHAR(100) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_policies]';

CREATE NONCLUSTERED INDEX IX_stg_policies_GroupId ON [$(ETL_SCHEMA)].[stg_policies] (GroupId);
CREATE NONCLUSTERED INDEX IX_stg_policies_BrokerId ON [$(ETL_SCHEMA)].[stg_policies] (BrokerId);

-- =============================================================================
-- Split Configurations (unique commission structures)
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_split_configs];
CREATE TABLE [$(ETL_SCHEMA)].[stg_split_configs] (
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_split_configs]';

-- =============================================================================
-- Proposals (consolidated by minimal differentiating keys)
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_proposals];
CREATE TABLE [$(ETL_SCHEMA)].[stg_proposals] (
    Id NVARCHAR(100) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_proposals]';

CREATE NONCLUSTERED INDEX IX_stg_proposals_GroupId ON [$(ETL_SCHEMA)].[stg_proposals] (GroupId);
CREATE NONCLUSTERED INDEX IX_stg_proposals_SplitConfigHash ON [$(ETL_SCHEMA)].[stg_proposals] (SplitConfigHash);

-- =============================================================================
-- Proposal Key Mapping (fine-grain to proposal lookup)
-- Enables deterministic F(Group, Year, Product, Plan) -> ProposalId
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_proposal_key_mapping];
CREATE TABLE [$(ETL_SCHEMA)].[stg_proposal_key_mapping] (
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_proposal_key_mapping]';

CREATE NONCLUSTERED INDEX IX_stg_proposal_key_mapping_ProposalId ON [$(ETL_SCHEMA)].[stg_proposal_key_mapping] (ProposalId);

-- =============================================================================
-- Proposal Products
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_proposal_products];
CREATE TABLE [$(ETL_SCHEMA)].[stg_proposal_products] (
    Id BIGINT NOT NULL,
    ProposalId NVARCHAR(100) NOT NULL,
    ProductCode NVARCHAR(100) NOT NULL,
    ProductName NVARCHAR(500),
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_proposal_products]';

-- =============================================================================
-- Hierarchies
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_hierarchies];
CREATE TABLE [$(ETL_SCHEMA)].[stg_hierarchies] (
    Id NVARCHAR(100) NOT NULL,
    Name NVARCHAR(500),
    [Description] NVARCHAR(2000),
    [Type] INT DEFAULT 0,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_hierarchies]';

CREATE NONCLUSTERED INDEX IX_stg_hierarchies_GroupId ON [$(ETL_SCHEMA)].[stg_hierarchies] (GroupId);
CREATE NONCLUSTERED INDEX IX_stg_hierarchies_BrokerId ON [$(ETL_SCHEMA)].[stg_hierarchies] (BrokerId);
...
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_splitseq_hierarchy_map];
CREATE TABLE [$(ETL_SCHEMA)].[stg_splitseq_hierarchy_map] (
    GroupId NVARCHAR(100) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_splitseq_hierarchy_map]';

CREATE NONCLUSTERED INDEX IX_stg_splitseq_hierarchy_map_HierarchyId 
ON [$(ETL_SCHEMA)].[stg_splitseq_hierarchy_map] (HierarchyId);

-- =============================================================================
-- Hierarchy Transform Work Tables (persist across GO batches)
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[work_hierarchy_data];
CREATE TABLE [$(ETL_SCHEMA)].[work_hierarchy_data] (
    GroupId NVARCHAR(100) NOT NULL,
    WritingBrokerId BIGINT NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[work_hierarchy_data]';

DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[work_unique_hierarchies];
CREATE TABLE [$(ETL_SCHEMA)].[work_unique_hierarchies] (
    GroupId NVARCHAR(100) NOT NULL,
    WritingBrokerId BIGINT NOT NULL,
    StructureSignature NVARCHAR(MAX),
...
PRINT 'Created [$(ETL_SCHEMA)].[work_unique_hierarchies]';

DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[work_split_participants];
CREATE TABLE [$(ETL_SCHEMA)].[work_split_participants] (
    GroupId NVARCHAR(100) NOT NULL,
    CertSplitSeq INT,
...
PRINT 'Created [$(ETL_SCHEMA)].[work_split_participants]';

DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[work_split_signatures];
CREATE TABLE [$(ETL_SCHEMA)].[work_split_signatures] (
    GroupId NVARCHAR(100) NOT NULL,
    CertSplitSeq INT,
    WritingBrokerId BIGINT,
    MinEffDate DATETIME2,
...
PRINT 'Created [$(ETL_SCHEMA)].[work_split_signatures]';

DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[work_hierarchy_id_map];
CREATE TABLE [$(ETL_SCHEMA)].[work_hierarchy_id_map] (
    GroupId NVARCHAR(100) NOT NULL,
    WritingBrokerId BIGINT,
    StructureSignature NVARCHAR(MAX),
    MinEffDate DATETIME2,
...
PRINT 'Created [$(ETL_SCHEMA)].[work_hierarchy_id_map]';

DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[work_splitseq_to_hierarchy];
CREATE TABLE [$(ETL_SCHEMA)].[work_splitseq_to_hierarchy] (
    GroupId NVARCHAR(100) NOT NULL,
    CertSplitSeq INT,
    WritingBrokerId BIGINT,
    HierarchyId NVARCHAR(100),
...
PRINT 'Created [$(ETL_SCHEMA)].[work_splitseq_to_hierarchy]';

-- =============================================================================
-- Hierarchy Versions
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_hierarchy_versions];
CREATE TABLE [$(ETL_SCHEMA)].[stg_hierarchy_versions] (
    Id NVARCHAR(100) NOT NULL,
    HierarchyId NVARCHAR(100),
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_hierarchy_versions]';

CREATE NONCLUSTERED INDEX IX_stg_hierarchy_versions_HierarchyId 
ON [$(ETL_SCHEMA)].[stg_hierarchy_versions] (HierarchyId);

-- =============================================================================
-- Hierarchy Participants
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_hierarchy_participants];
CREATE TABLE [$(ETL_SCHEMA)].[stg_hierarchy_participants] (
    Id NVARCHAR(100) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_hierarchy_participants]';

CREATE NONCLUSTERED INDEX IX_stg_hierarchy_participants_HierarchyVersionId 
ON [$(ETL_SCHEMA)].[stg_hierarchy_participants] (HierarchyVersionId);

CREATE NONCLUSTERED INDEX IX_stg_hierarchy_participants_EntityId 
ON [$(ETL_SCHEMA)].[stg_hierarchy_participants] (EntityId);

-- =============================================================================
-- State Rules - Groups products by state within a hierarchy version
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_state_rules];
CREATE TABLE [$(ETL_SCHEMA)].[stg_state_rules] (
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_state_rules]';

CREATE NONCLUSTERED INDEX IX_stg_state_rules_HierarchyVersionId 
ON [$(ETL_SCHEMA)].[stg_state_rules] (HierarchyVersionId);

-- =============================================================================
-- State Rule States - Which state codes belong to each state rule
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_state_rule_states];
CREATE TABLE [$(ETL_SCHEMA)].[stg_state_rule_states] (
    Id NVARCHAR(200) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_state_rule_states]';

CREATE NONCLUSTERED INDEX IX_stg_state_rule_states_StateRuleId 
ON [$(ETL_SCHEMA)].[stg_state_rule_states] (StateRuleId);

-- =============================================================================
-- Hierarchy Splits - Products within each state rule
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_hierarchy_splits];
CREATE TABLE [$(ETL_SCHEMA)].[stg_hierarchy_splits] (
    Id NVARCHAR(200) NOT NULL,
    StateRuleId NVARCHAR(200) NOT NULL,
    ProductId NVARCHAR(100),
    ProductCode NVARCHAR(100) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_hierarchy_splits]';

CREATE NONCLUSTERED INDEX IX_stg_hierarchy_splits_StateRuleId 
ON [$(ETL_SCHEMA)].[stg_hierarchy_splits] (StateRuleId);

CREATE NONCLUSTERED INDEX IX_stg_hierarchy_splits_ProductCode 
ON [$(ETL_SCHEMA)].[stg_hierarchy_splits] (ProductCode);

-- =============================================================================
-- Split Distributions - Links participants to products with schedules
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_split_distributions];
CREATE TABLE [$(ETL_SCHEMA)].[stg_split_distributions] (
    Id NVARCHAR(200) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_split_distributions]';

CREATE NONCLUSTERED INDEX IX_stg_split_distributions_HierarchySplitId 
ON [$(ETL_SCHEMA)].[stg_split_distributions] (HierarchySplitId);

CREATE NONCLUSTERED INDEX IX_stg_split_distributions_HierarchyParticipantId 
ON [$(ETL_SCHEMA)].[stg_split_distributions] (HierarchyParticipantId);

-- =============================================================================
-- Premium Split Versions
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_premium_split_versions];
CREATE TABLE [$(ETL_SCHEMA)].[stg_premium_split_versions] (
    Id NVARCHAR(100) NOT NULL,
    GroupId NVARCHAR(100) NOT NULL,
    GroupName NVARCHAR(500),
    ProposalId NVARCHAR(100) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_premium_split_versions]';

CREATE NONCLUSTERED INDEX IX_stg_premium_split_versions_ProposalId 
ON [$(ETL_SCHEMA)].[stg_premium_split_versions] (ProposalId);

-- =============================================================================
-- Premium Split Participants
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_premium_split_participants];
CREATE TABLE [$(ETL_SCHEMA)].[stg_premium_split_participants] (
    Id NVARCHAR(100) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_premium_split_participants]';

CREATE NONCLUSTERED INDEX IX_stg_premium_split_participants_VersionId 
ON [$(ETL_SCHEMA)].[stg_premium_split_participants] (VersionId);

-- =============================================================================
-- Commission Assignment Versions
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_commission_assignment_versions];
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_commission_assignment_versions]';

-- =============================================================================
-- Commission Assignment Recipients
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_commission_assignment_recipients];
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_commission_assignment_recipients]';

-- =============================================================================
-- Premium Transactions (for commission calculation)
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_premium_transactions];
CREATE TABLE [$(ETL_SCHEMA)].[stg_premium_transactions] (
    Id NVARCHAR(100) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_premium_transactions]';

CREATE NONCLUSTERED INDEX IX_stg_premium_transactions_CertificateId 
ON [$(ETL_SCHEMA)].[stg_premium_transactions] (CertificateId);

CREATE NONCLUSTERED INDEX IX_stg_premium_transactions_TransactionDate 
ON [$(ETL_SCHEMA)].[stg_premium_transactions] (TransactionDate);

-- =============================================================================
-- Fee Schedules
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_fee_schedules];
CREATE TABLE [$(ETL_SCHEMA)].[stg_fee_schedules] (
    Id NVARCHAR(100) NOT NULL,
    GroupId NVARCHAR(100) NOT NULL,
    GroupName NVARCHAR(500),
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_fee_schedules]';
...
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_policy_hierarchy_assignments];
CREATE TABLE [$(ETL_SCHEMA)].[stg_policy_hierarchy_assignments] (
    Id NVARCHAR(100) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_policy_hierarchy_assignments]';

CREATE NONCLUSTERED INDEX IX_stg_policy_hierarchy_assignments_PolicyId 
ON [$(ETL_SCHEMA)].[stg_policy_hierarchy_assignments] (PolicyId);

CREATE NONCLUSTERED INDEX IX_stg_policy_hierarchy_assignments_HierarchyId 
ON [$(ETL_SCHEMA)].[stg_policy_hierarchy_assignments] (HierarchyId);
...
-- =============================================================================
DROP TABLE IF EXISTS [$(ETL_SCHEMA)].[stg_policy_hierarchy_participants];
CREATE TABLE [$(ETL_SCHEMA)].[stg_policy_hierarchy_participants] (
    Id NVARCHAR(100) NOT NULL,
...
PRINT 'Created [$(ETL_SCHEMA)].[stg_policy_hierarchy_participants]';

CREATE NONCLUSTERED INDEX IX_stg_policy_hierarchy_participants_AssignmentId 
ON [$(ETL_SCHEMA)].[stg_policy_hierarchy_participants] (PolicyHierarchyAssignmentId);

CREATE NONCLUSTERED INDEX IX_stg_policy_hierarchy_participants_BrokerId 
ON [$(ETL_SCHEMA)].[stg_policy_hierarchy_participants] (BrokerId);
